        ...
        execute: function() {
            SideMenuCtrl = (function () {
                ...
                SideMenuCtrl.prototype.openAdminDropdown = function () {
                    ...
                    if (this.isSignedIn) {
                        this.AdmMenu.push({ text: "Sign out", url: this.getUrl("/logout"), target: "_self" });
                    }
                    ...
                    this.backendSrv.get('/api/user/orgs').then(function (orgs) {
                        ...
                        if (config_1.default.allowOrgCreate) {
                            _this.AdmMenu.push({ text: "Update Maintenance", icon: "fa fa-fw fa-plus", url: _this.getUrl('/org/new') });
                        }
                    });
                };
